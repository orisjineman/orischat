...
module.exports = {
  ...
  MAX_PINS_PER_ROOM: 10,
  EXPORT_MESSAGE_LIMIT: 5000,

  // 링크 미리보기: 서버가 대신 페이지를 열어보므로 내부망 주소는 막음. 테스트에서만
  // 로컬 서버를 쓰려고 이 값을 켬 — 실제 운영에서는 켜지 말 것.
  LINK_PREVIEW_ALLOW_PRIVATE: process.env.LINK_PREVIEW_ALLOW_PRIVATE === '1',
